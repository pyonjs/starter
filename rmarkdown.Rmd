...
In order to simulate the data, we used the mixed effects model for each of the treatments. For this data, we wish to have the dietary treatment to have a linear decrease in weight by 3g. This decrease, along with the mean and standard deviation of the mice, helps us simulate the data we need. In order to keep that data simple and true, the random effects of both models are kept the same, with only the movement of the treatment group decreasing.
